  ...
  prelims: [
    {
      ...
      category: 'Academic',
      image: '/assets/images/segments/24 Math Olympiad Competition.jpg',
      registration: {
    ...
    },
    {
      ...
      image: '/assets/images/segments/27 Hackathon.jpg',
      registration: {
    ...
    },
    {
      ...
      image: '/assets/images/segments/28 Programming Contest.jpg',
      registration: {
  ...
  mainSegments: [
    {
      ...
      category: 'Design',
      image: '/assets/images/segments/23 UIUX Competition.jpg',
      registration: {
    ...
    },
    {
      ...
      category: 'Security',
      image: '/assets/images/segments/25 Capture The Flag Competition.jpg',
      registration: {
    ...
    },
    {
      ...
      category: 'Academic',
      image: '/assets/images/segments/26 Quiz Competition.jpg',
      registration: {
    ...
    },
    {
      ...
      date: 'August 27, 2025',
      time: 'TBA',
      description: 'The main hackathon event - build the next big thing!',
      category: 'Development',
      image: '/assets/images/segments/27 Hackathon.jpg',
      registration: {
    ...
    },
    {
      ...
      date: 'August 28, 2025',
      time: 'TBA',
      description: 'The ultimate programming challenge - solve complex algorithms onsite.',
      category: 'Programming',
      image: '/assets/images/segments/28 Programming Contest.jpg',
      registration: {
    ...
    },
    {
      ...
      type: 'Onsite',
      date: 'August 24 - August 28, 2025',
      duration: '5 days',
      time: 'TBA',
      description: 'Strategic chess tournament running throughout the carnival.',
      category: 'Strategy',
      image: '/assets/images/segments/28 Chess Competition.jpg',
      registration: {
        deadline: 'August 22, 2025',
        fee: 'TBA',
        teamSize: 'Individual'
    ...
    },
    {
      ...
      category: 'Gaming',
      image: '/assets/images/segments/28 E-Sports Tournaments.jpg',
      registration: {
        deadline: 'August 22, 2025',
        fee: 'TBA',
